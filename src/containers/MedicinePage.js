    ...
    <main className="medicinePage__contianer">
      ...
      <div className="delivery__container">
        ...
        <p className="delivery__container__text">
          Delivery fees are set based on the following address, and this is the
          address that the medication will be delivered to
        </p>
        <span>
          <img src={LocationIcon} alt="location-icon" /> Mansoura City, Gehan St
        </span>
        <Button className="btn btn-green btn-lg delivery__container__btn">
          Change address
        </Button>
      </div>
